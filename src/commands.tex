...
\newcommand\leveltype[2]{%
    \edef\tempb{#1}%
    \ifstrequal{tempb}{1}{\addcontentsline{toc}{section}{#2}}{%
      \ifstrequal{\tempb}{2}{\addcontentsline{toc}{subsection}{#2}}{%
        \ifstrequal{\tempb}{3}{\addcontentsline{toc}{subsubsection}{#2}}{%
          \ifstrequal{\tempb}{4}{\addcontentsline{toc}{subsubsubsection}{#2}}
