...
\newcommand\leveltoc[1]{%
    \ifstrequal{\thenestedlevel}{1}{\addcontentsline{toc}{section}{#1}}{%
      \ifstrequal{\thenestedlevel}{2}{\addcontentsline{toc}{subsection}{#1}}{%
        \ifstrequal{\thenestedlevel}{3}{\addcontentsline{toc}{subsubsection}{#1}}{%
          \ifstrequal{\thenestedlevel}{4}{\addcontentsline{toc}{subsubsubsection}{#1}}
            {\addcontentsline{toc}{subsubsubsubsection}{#1}}}}}
}

\newcommand*\climbingarea[3]{%
% A Crag, cliff, sector, etc
% name
% header
% multicol content
    \addtocounter{nestedlevel}{1}
    \section*{#1}
    \leveltoc{#1}#2
    \begin{multicols}{2}%
        \resetcstep#3
