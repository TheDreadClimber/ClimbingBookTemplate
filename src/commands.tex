...
\newcommand\leveltype[1]{%
    \edef\tempb{#1}%
    \ifstrequal{tempb}{1}{section}{%
      \ifstrequal{\tempb}{2}{subsection}{%
        \ifstrequal{\tempb}{3}{subsubsection}{%
          \ifstrequal{\tempb}{4}{subsubsubsection}
            {subsubsubsubsection}}}}
}
...
% multicol content
    ...
    \section*{#1}
    \edef\levelname{\leveltype{\thenestedlevel}}
    \addcontentsline{toc}{\levelname}{#1}#2
    \begin{multicols}{2}%
        \resetcstep#3
    \end{multicols}
    \addtocounter{nestedlevel}{-1}
