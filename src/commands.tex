...
\newcommand\leveltoc[1]{%
    \ifstrequal{\thenestedlevel}{1}{\addcontentsline{toc}{section}{#2}}{%
      \ifstrequal{\thenestedlevel}{2}{\addcontentsline{toc}{subsection}{#2}}{%
        \ifstrequal{\thenestedlevel}{3}{\addcontentsline{toc}{subsubsection}{#2}}{%
          \ifstrequal{\thenestedlevel}{4}{\addcontentsline{toc}{subsubsubsection}{#2}}
            {\addcontentsline{toc}{subsubsubsubsection}{#2}}}}}
}
