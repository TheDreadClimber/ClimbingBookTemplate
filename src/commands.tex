...
\newcommand{\stars}[1]{%
  \raisebox{.5ex}{\multido{\i=1+1}{#1}{$\star$}}%
}
...
% {@param} #1 Name
% {@param} #2 Header and Subareas
% {@param} #3 Routes
  \addtocounter{nestedlevel}{1}%
  \begingroup
    \ifnum\value{nestedlevel}=1
       \chapter*{#1}
       \addcontentsline{toc}{chapter}{#1}
       \markboth{#1}{#1}
    \else\section*{#1}\ifnum\value{nestedlevel}=2
      \addcontentsline{toc}{section}{#1}%
    \else\ifnum\value{nestedlevel}=3
      \addcontentsline{toc}{subsection}{#1}%
    \else\ifnum\value{nestedlevel}=4
      \addcontentsline{toc}{subsubsection}{#1}%
    \else\ifnum\value{nestedlevel}=5
...
\expandafter\def\csname ydssort@5.12+\endcsname{111}
\expandafter\def\csname ydssort@5.13\endcsname{119}
...
\expandafter\def\csname ydssort@5.13c/d\endcsname{132}
