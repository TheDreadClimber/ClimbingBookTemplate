...
\def\chartone{%
  \begin{climbhchart}
	    \addplot coordinates {(${\leq}.6$,0) (.7,0) (.8,0) (.9,0) (.10,1) (.11,0) (.12,0) (.13,0) (.14,0)};% chktex 1
        \addplot coordinates {(.9,1)};% chktex 1
  \end{climbhchart} 
}
\def\charttwo{%
  \begin{climbhchart}
	    \addplot coordinates {(${\leq}.6$,1) (.7,0) (.8,0) (.9,0) (.10,2) (.11,0) (.12,0) (.13,0) (.14,0)};% chktex 1
        \addplot coordinates {(${\leq}.6$,1) (.7,0) (.8,0) (.9,0) (.10,1) (.11,0) (.12,0) (.13,0) (.14,0)};% chktex 1
		\addplot coordinates {(${\leq}.6$,0) (.7,0) (.8,1) (.9,0) (.10,0) (.11,1)};% chktex 1
  \end{climbhchart}
}
