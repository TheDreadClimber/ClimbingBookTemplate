...
\pgfplotsset{width=7cm,height=2cm,compat=1.17}
\def\chartone{%
  \begin{tikzpicture}
    \begin{axis}[
	    axis lines=left,
	    ...
	    \addplot+[ybar] plot coordinates {($\leq.6$,1) (.7,0) (.8,0) (.9,0) (.10,1) (.11,0) (.12,0) (.13,0) (.14,0)};
...
\def\charttwo{%
  \begin{tikzpicture}
    \begin{axis}[
	    ...
	    \addplot coordinates {($\leq.6$,0) (.7,0) (.8,0) (.9,0) (.10, 2) (.11,0) (.12,0) (.13,0) (.14,0)};
