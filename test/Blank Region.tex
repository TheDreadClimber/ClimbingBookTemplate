...
\def\charttwo{%
  \pgfplotsset{cycle list={%
    {white},{blue,fill=blue!50!white},{red, fill=red!50!white},{green, green!50!white}
  },width=7cm,height=2cm,compat=1.8}
  \begin{tikzpicture}
    \begin{axis}[
	    axis lines=left,
		axis line style={draw=white},
	    ...
	    \addplot+[ybar,color=white] plot coordinates {($\leq.6$,0) (.7,0) (.8,0) (.9,0) (.10, 0) (.11,0) (.12,0)};
	    \addplot+[ybar,color=blue!50!white] plot coordinates {($\leq.6$,1) (.7,0) (.8,0) (.9,0) (.10,2)};
        \addplot+[ybar,color=red!50!white] plot coordinates {($\leq.6$,1) (.9,1) (.10,1)};
    \end{axis}
  \end{tikzpicture}
}
