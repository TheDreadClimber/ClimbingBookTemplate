...
\def\chart1{%
  ...
  \begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot+[ybar] plot coordinates {(5.4,0) (5.5,0) (5.6,0) (5.7,0) (5.8,0) (5.9,1) (5.10a,0) (5.10b,0) (5.10c,0)};
        \addplot+[ybar] plot coordinates {(5.4,0) (5.5,0) (5.6,0) (5.7,0) (5.8,0) (5.9,0) (5.10a,0) (5.10b,0) (5.10c,1)};
    \end{axis}
  \end{tikzpicture}
}
\def\chart2{%
...
\climbingarea{First Wall}{%
    ...
    \begin{tabular}{c c c c} 
          ...
          First Wall & 2 & \chart1 &   \\ 
          \midrule
          Boulderfield Wall & 8 & \chart2 & Sporty McSportface \\ [1ex]
          \bottomrule
        \end{tabular}
