...
\def\chartoneh{%
  \begin{climbhchart}
	    \addplot table[x=sport,y=grade{\climbdataone};
        \addplot table[x=trad,y=grade]{\climbdataone};
  \end{climbhchart}
}
\def\chartonev{%
  \begin{climbhcvart}
...
\def\charttwoh{%
    \begin{climbhchart}
        \addplot table[x=grade,y=sport{\climbdatatwo};
        \addplot table[x=grade,y=trad]{\climbdatatwo};
        \addplot table[x=grade,y=boulder]{\climbdatatwo};
    \end{climbhchart}
}

\def\charttwov{%
    \begin{climbhchart}
        \addplot table[y=grade,x=sport{\climbdatatwo};
        \addplot table[y=grade,x=trad]{\climbdatatwo};
        \addplot table[y=grade,x=boulder]{\climbdatatwo};
    \end{climbhchart}
}
