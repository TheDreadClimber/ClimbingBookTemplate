...
\def\chartone{%
  \begin{tikzpicture}
    \begin{axis}[
	    ...
	    \addplot+[ybar] plot coordinates {($\leq.6$,NA) (.7,NA) (.8,NA) (.9,NA) (.10,1) (.11,NA) (.12,NA) (.13,NA) (.14,NA)};
...
\def\charttwo{%
  \begin{tikzpicture}
    \begin{axis}[
	    ...
	    \addplot coordinates {($\leq.6$,0) (.7,0) (.8,0) (.9,0) (.10, 0) (.11,0) (.12,0)};
	    \addplot coordinates {($\leq.6$,1) (.7,0) (.8,0) (.9,0) (.10,2)};
        \addplot coordinates {($\leq.6$,1) (.9,1) (.10,1)};
    \end{axis}
  \end{tikzpicture}
}
