...
\def\charttwo{%
  ...
  \begin{tikzpicture}
    \begin{axis}[
	    ...
	    \addplot+[ybar,color=white] plot coordinates {(.6,0) (.7,0) (.8,0) (.9,0) (.10, 0) (.11,0) (.12,0)};
	    \addplot+[ybar,color=blue] plot coordinates {(.6,1) (.7,0) (.8,0) (.9,0) (.10,2)};
        \addplot+[ybar,color=red] plot coordinates {(.6,1) (.9,1) (.10,1)};
    \end{axis}
  \end{tikzpicture}
}
